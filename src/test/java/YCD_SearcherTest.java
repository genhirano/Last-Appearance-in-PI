...
import static org.junit.jupiter.api.Assertions.*;
    ...
    class YCD_SearcherTest extends TestBase{
        ...
        void 検索一般(TestInfo testInfo) throws InterruptedException {
            ...
            targetMap.put("141592", new HashMap<YCD_Searcher.Container, String>() {
                {
                    put(YCD_Searcher.Container.START_DIGIT, "1");
                }
            });
            targetMap.put("1415926", new HashMap<YCD_Searcher.Container, String>() {
                {
                    put(YCD_Searcher.Container.START_DIGIT, "2");
                }
            });
            targetMap.put("612173125117978466726688273303", new HashMap<YCD_Searcher.Container, String>() {
                {
                    put(YCD_Searcher.Container.START_DIGIT, "2");
                }
            });
            targetMap.put("99999999999999", new HashMap<YCD_Searcher.Container, String>() {
                {
                    put(YCD_Searcher.Container.START_DIGIT, "2");
                }
            });
            targetMap.put("9096", new HashMap<YCD_Searcher.Container, String>() {
                {
        ...
        void 検索_ファイル末端と次のファイルの境界(TestInfo testInfo) throws InterruptedException {
            ...
            //"61217"
            // ↑ 2,000,001
            targetMap.put("61217", new HashMap<YCD_Searcher.Container, String>() {
                {
                    put(YCD_Searcher.Container.START_DIGIT, "1999998");
                }
            });
            ...
            //"909"
            //   ↑ 2,000,000
            targetMap.put("909", new HashMap<YCD_Searcher.Container, String>() {
                {
                    put(YCD_Searcher.Container.START_DIGIT, "1999998");
                }
            });
            ...
            //"961217"
            // ↑ 2,000,000
            targetMap.put("961217", new HashMap<YCD_Searcher.Container, String>() {
                {
                    put(YCD_Searcher.Container.START_DIGIT, "1999998");
                }
            });
        ...
        @org.junit.jupiter.api.Test
        void ターゲットマップチェック(TestInfo testInfo) throws InterruptedException {
            List<File> fileList = createFileList();
            Map<String, Map<YCD_Searcher.Container, String>> targetMap = new HashMap<>();
